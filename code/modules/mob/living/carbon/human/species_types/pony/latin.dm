...
/datum/language_holder/golem
	understood_languages = list(/datum/language/latin = list(LANGUAGE_ATOM))
	spoken_languages = list(/datum/language/latin = list(LANGUAGE_ATOM))
