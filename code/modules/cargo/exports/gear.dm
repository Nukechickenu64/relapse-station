...
/datum/export/gear/sec_helmet/medium
	cost = 80 DOLLARS
	unit_name = "medium helmet"
	export_types = list(/obj/item/clothing/head/helmet/medium)

/datum/export/gear/sec_helmet/heavy
	cost = 125.5 DOLLARS
	unit_name = "medium helmet"
	export_types = list(/obj/item/clothing/head/helmet/heavy)

/datum/export/gear/sec_helmet/ultraheavy
	cost = 200 DOLLARS
	unit_name = "medium helmet"
	export_types = list(/obj/item/clothing/head/helmet/heavy)
...
/datum/export/gear/sec_armor/medium
	cost = 73.5 DOLLARS
	unit_name = "medium armor vest"
	export_types = list(/obj/item/clothing/suit/armor/vest/alt/medium)

/datum/export/gear/sec_armor/heavy
	cost = 90 DOLLARS
	unit_name = "heavy armor vest"
	export_types = list(/obj/item/clothing/suit/armor/vest/alt/heavy)
