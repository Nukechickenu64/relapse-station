...
#define OPENSPACE_BACKDROP_PLANE -21
//Transparent floors that should display above openspace
#define TRANSPARENT_FLOOR_PLANE -20
...
#define GRILLE_LAYER 4.16
#define WINDOW_LAYER 4.17
#define ABOVE_WINDOW_LAYER 4.18
#define WALL_OBJ_LAYER 4.19
