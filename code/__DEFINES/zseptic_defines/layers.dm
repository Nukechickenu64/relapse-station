...
#define OPENSPACE_BACKDROP_PLANE -26
//Transparent floors that should display above openspace
#define TRANSPARENT_FLOOR_PLANE -25

#define FLOOR_PLANE -24
#define FLOOR_RENDER_TARGET "FLOOR_PLANE"
#define FLOOR_PLANE_FOV_HIDDEN -23
#define FLOOR_PLANE_BLOOM -22
#define GAME_PLANE_EFFECTS -21
#define GAME_EFFECTS_RENDER_TARGET "GAME_PLANE_EFFECTS"
#define GAME_PLANE -20
#define GAME_RENDER_TARGET "GAME_PLANE"
#define GAME_PLANE_BLOOM -19
#define GAME_PLANE_WINDOW -18
...
#define GAME_PLANE_UPPER_FOV_HIDDEN -13
#define GAME_PLANE_OBJECT_PERMANENCE -12
#define ABOVE_GAME_PLANE -11
#define POLLUTION_PLANE -10
#define RIPPLE_PLANE -9
#define FRILL_PLANE_WINDOW -8
#define FRILL_PLANE_LOW -7
#define FRILL_PLANE -6
#define FRILL_RENDER_TARGET "FRILL_PLANE"
#define GAME_PLANE_UNDER_FRILL -5
#define GAME_UNDER_FRILL_RENDER_TARGET "GAME_PLANE_UNDER_FRILL"
#define OUTLINE_PLANE -4
...
#define BLOOD_PROJECTILE_LAYER 4.55
...
#define WALL_OBJ_LAYER 6.2
#define ABOVE_FRILL_LAYER 6.3
