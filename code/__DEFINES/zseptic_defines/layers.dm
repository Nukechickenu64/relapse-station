...
#define LIQUID_FIRE_LAYER 3.55
#define TURF_FIRE_LAYER 3.56

// GAME_PLANE_WINDOW layers
#define WINDOW_FULLTILE_LAYER 3.57
#define ABOVE_WINDOW_FULLTILE_LAYER 3.58

// GAME_PLANE_MIDDLE layers
#define GRILLE_LAYER 3.6
#define ABOVE_GRILLE_LAYER 3.61
...
#define WINDOW_LOW_LAYER 3.69
#define ABOVE_WINDOW_LOW_LAYER 3.7
