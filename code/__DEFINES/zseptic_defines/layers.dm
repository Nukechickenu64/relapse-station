...
#define OPENSPACE_BACKDROP_PLANE -27
//Transparent floors that should display above openspace
#define TRANSPARENT_FLOOR_PLANE -26

#define FLOOR_PLANE -26
#define FLOOR_RENDER_TARGET "FLOOR_PLANE"
#define FLOOR_PLANE_FOV_HIDDEN -24
#define FLOOR_PLANE_BLOOM -23
#define GAME_PLANE_EFFECTS -22
