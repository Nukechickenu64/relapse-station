...
#define INTERACTION_AUDIBLE (1<<2)
/// User and target must be adjacent
#define INTERACTION_NEEDS_PHYSICAL_CONTACT (1<<3)
/// Interaction will call climax() on the user, if applicable
#define INTERACTION_USER_CLIMAX (1<<3)
/// Interaction will call climax() on the target, if applicable
#define INTERACTION_TARGET_CLIMAX (1<<4)
...
#define INTERACTION_CATEGORY_SEXO "Forbidden Fruits"
...
/// Factor at which humans lose their proximity to cumming, per second
