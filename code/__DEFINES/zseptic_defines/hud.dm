...
//Middle right (alerts)
#define ui_alert1 "EAST-2,SOUTH+1"
#define ui_alert2 "EAST-2,SOUTH+2"
#define ui_alert3 "EAST-2,SOUTH+3"
#define ui_alert4 "EAST-2,SOUTH+4"
#define ui_alert5 "EAST-2,SOUTH+5"
#define ui_alert6 "EAST-2,SOUTH+6"
