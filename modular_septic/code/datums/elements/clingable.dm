...
/datum/element/clingable/Attach(datum/target, clinging_skill = SKILL_ACROBATICS, clinging_requirement = 10, clinging_sound = 'modular_septic/sound/effects/clung.ogg')
