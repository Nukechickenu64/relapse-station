...
/mob/proc/diceroll(requirement = 0, crit = 10, dice_num = 3, dice_sides = 6, count_modifiers = TRUE, return_flags = RETURN_DICE_SUCCESS)
	return attributes ? attributes.diceroll(requirement, crit, dice_num, dice_sides, count_modifiers, return_flags) : DICE_FAILURE
