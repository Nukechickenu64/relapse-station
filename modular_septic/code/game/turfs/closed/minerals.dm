...
/turf/closed/mineral/shale
	icon = 'modular_septic/icons/turf/tall/walls/shale.dmi'
	smooth_icon = 'modular_septic/icons/turf/tall/walls/shale.dmi'
	frill_icon = 'modular_septic/icons/turf/tall/walls/shale_frill.dmi'
	icon_state = "shale-0"
	plane = GAME_PLANE
