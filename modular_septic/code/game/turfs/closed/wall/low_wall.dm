/turf/closed/wall/low_wall
	...
	icon = 'modular_septic/icons/turf/mew/walls/low_walls/iron.dmi'
...
/turf/closed/wall/low_wall/proc/on_painted(turf/closed/wall/low_wall/source, is_dark_color = FALSE)
	SIGNAL_HANDLER
...
///creates a window from the typepath given from window_type, which is either a glass sheet typepath or a /obj/structure/window subtype
/turf/closed/wall/low_wall/proc/create_structure_grille(window_type, start_anchored = TRUE)
...
/turf/closed/wall/low_wall/reinforced/grille
	start_with_grille = TRUE
