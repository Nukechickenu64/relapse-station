...
/datum/wound/blunt/brainspill/proc/debrain_animation(mob/living/carbon/debrained)
	...
	animate(mushy_pea_brain, transform = mushy_pea_brain.transform.Scale(1, 0.65), time = 1 SECONDS, easing = EASE_IN | BOUNCE_EASING)
	sleep(1 SECONDS)
	if(QDELETED(mushy_pea_brain))
		return
