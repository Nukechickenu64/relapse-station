/obj/item/organ/tendon/l_arm
	name = "left distal biceps tendon"
	zone = BODY_ZONE_L_ARM

/obj/item/organ/tendon/l_arm/robot
...
/obj/item/organ/tendon/l_arm/robot/get_wound_resistance(wounding_type = WOUND_BLUNT)
