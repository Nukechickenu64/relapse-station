/obj/item/organ/tendon/r_leg
	name = "right cruciate ligament"
	zone = BODY_ZONE_R_LEG

/obj/item/organ/tendon/r_leg/robot
...
/obj/item/organ/tendon/r_leg/robot/get_wound_resistance(wounding_type = WOUND_BLUNT)
