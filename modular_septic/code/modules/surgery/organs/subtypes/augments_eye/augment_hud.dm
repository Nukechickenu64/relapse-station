...
/obj/item/organ/cyberimp/eyes/hud/Insert(mob/living/carbon/new_owner, special = 0, drop_if_replaced = FALSE)
	. = ..()
	if(HUD_type)
...
/obj/item/organ/cyberimp/eyes/hud/Remove(mob/living/carbon/old_owner, special = 0)
	if(HUD_type)
		var/datum/atom_hud/atom_hud = GLOB.huds[HUD_type]
